                                        ...
                                        <div class="col-md-6">
                                            <a href="job-profile.html">
                                                <div class="border job-item mb-3">
                                                    <div class="d-flex align-items-center p-3 job-item-header">
                                                        <div class="overflow-hidden mr-2">
                                                            <h6 class="font-weight-bold text-dark mb-0 text-truncate">C#
                                                                Developer</h6>
                                                    ...
                                                    <div class="media-body">
                                                        <div class="mb-3">
                                                            <h6 class="font-weight-bold mb-0"><a class="text-dark"
                                                                    href="job-profile.html">C# Developer</a></h6>
                                                            <a class="d-inline-block small pt-1"
                                                                ...
                                                                <span
                                                                    class="text-dark font-weight-bold ml-2">3.74</span>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <div class="border-right pr-3 mr-3">
                                                                <a class="text-secondary small"
                                                                    href="job-profile.html">Salaries</a>
                                                            </div>
                                            ...
                                            <div class="border shadow-sm border rounded bg-white job-item-2 p-3 mb-3">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <div class="mb-3">
                                                            <h6 class="font-weight-bold mb-0"><a class="text-dark"
                                                                    href="job-profile.html">Junior UX Designer</a></h6>
                                                            <a class="d-inline-block small pt-1"
                                                                href="job-profile.html">
                                                                <span class="text-warning">
                                                                    <span class="feather-star"></span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card overflow-hidden">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">121 King Street, Melbourne Victoria 3000
                                                        Australia</p>
                                                    <a href="#" class="text-link font-weight-bold"><i
                                                            class="feather-external-link"></i> Get Directions</a>
                                                </div>
                                            ...
                                            <a href="profile.html">
                                                <div class="border network-item rounded mb-3">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="overlap-rounded-circle">
                                                            <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                                data-placement="top" title="" src="img/p6.png" alt=""
                                                                data-original-title="Sophia Lee"/>
                                                            <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                                data-placement="top" title="" src="img/p7.png" alt=""
                                                                data-original-title="John Doe"/>
                                                            <img class="rounded-circle shadow-sm" data-toggle="tooltip"
                                                                data-placement="top" title="" src="img/p8.png" alt=""
                ...
                <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
                    ...
                    <div class="shadow-sm rounded bg-white job-item-2 p-3 mb-3">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="mb-3">
                                    <h6 class="font-weight-bold mb-0"><a class="text-dark" href="job-profile.html">C#
                                            Developer</a></h6>
                    ...
                    <div class="box shadow-sm border rounded bg-white mb-3">
                        ...
                        <div class="box-body p-3">
                            <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                                ...
                                <span class="ml-auto"><button type="button" class="btn btn-outline-primary btn-sm"><i
