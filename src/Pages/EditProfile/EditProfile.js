           ...
           <aside class="col-md-4">
                       ...
                       <div class="p-3 border-bottom">
                           ...
                           <div class="form-group mb-0">
                               ...
                               <div class="custom-control custom-checkbox d-inline mr-3">
                                   ...
                                   <label class="custom-control-label" for="customCheck1">JavaScript,
                                       jQuery</label>
                               </div>
               ...
               <div class="border rounded bg-white mb-3">
                   ...
                   <div class="box-body">
                       ...
                       <div class="overflow-hidden text-center p-3">
                           <a class="font-weight-bold btn btn-light rounded p-3 d-block" href="#"> Update Social
                               Profiles </a>
                       </div>
                   </div>
               </div>
                                   ...
                                   <div class="js-form-message">
                                       ...
                                       <div class="form-group">
                                           <input type="text" class="form-control" name="name"
                                               value="Gurdeep Osahan" placeholder="Enter your name"
                                   ...
                                   <div class="js-form-message">
                                       <div class="form-group">
                                           <select class="form-control custom-select" required=""
                                               ...
                                               <option value="birthYearSelect1986" selected="selected">1986
                                               </option>
                                   ...
                                   <div class="js-form-message">
                                       ...
                                       <div class="form-group">
                                           <input class="form-control" type="url" name="website"
                                               ...
                                               data-error-class="u-has-error" data-success-class="u-has-success"/>
                                           <small class="form-text text-muted">Your home page, blog or company
                                               site, e.g. http://example.com</small>
                                       </div>
                                   </div>
                               </div>
