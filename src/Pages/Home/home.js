        ...
        <div class="container">
          <div class="row">
            ...
            <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
              <div
                class="box mb-3 shadow rounded bg-white profile-box text-center"
              ...
              >
                <div class="py-4 px-3 border-bottom">
                  ...
                  <Link
                    to="/EditProfile"
                    className="border rounded p-2 mt-5 btn-outline-secondary"
                  >
                    <img
                      width="18"
                      height="18"
                ...
                <Link
                  className="d-block"
                  style={{ boxShadow: "rgb(0, 0, 0, 0.1) 0px 0px 2px 0px" }}
                >
                  <img
                    width="18"
                    height="18"
                    src="https://img.icons8.com/fluency/48/contract-job.png"
                    alt="contract-job"
                  />
                  User Profile
                </Link>
                ...
                >
                  <img
                    ...
                    height="18"
                    className=""
                    src="https://img.icons8.com/color/48/friends--v1.png"
                    alt="friends--v1"
                  />
                ...
                <Link
                  className="d-block"
                  style={{
                    boxShadow: "rgb(0, 0, 0, 0.1) 0px 0px 2px 0px",
                    paddingRight: "39px",
                  }}
                >
                  <img
                    width="18"
                    height="18"
                    src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-jobs-recruitment-agency-flaticons-flat-flat-icons-3.png"
                    alt="external-jobs-recruitment-agency-flaticons-flat-flat-icons-3"
                  />
                  Jobs
                </Link>
                <Link
                ...
                >
                  <img
                    width="18"
                    height="18"
                    src="https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-jobs-millennial-flaticons-flat-flat-icons.png"
                    alt="external-jobs-millennial-flaticons-flat-flat-icons"
                  />
                  My Jobs
                </Link>
              </div>
